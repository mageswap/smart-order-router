...
interface ImmutableStateTestInterface extends ethers.utils.Interface {
  functions: {
...
export class ImmutableStateTest extends BaseContract {
  ...
  interface: ImmutableStateTestInterface;
