...
interface MockTimeSwapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeSwapRouter02 extends BaseContract {
  ...
  interface: MockTimeSwapRouter02Interface;
